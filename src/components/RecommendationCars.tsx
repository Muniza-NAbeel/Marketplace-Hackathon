...
export default function RecommendationCars() {
  const recommendedCars = [
          ...
          {recommendedCars.map((car) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-[#1A202C] font-semibold text-[16px]">{car.name}</h3>
                {car.name === "CR-V" || car.name === "MG ZX Exclusice" ? (
              ...
              {/* Car Type */}
              <p className="text-[#90A3BF] font-[600] text-sm mb-4">{car.type}</p>
    ...
    <button className="bg-[#3563E9] text-white w-[156px] h-[44px] rounded-[4px] px-[20px] gap-[8px] font-semibold text-[16px] leading-[24px] tracking-[-2%] text-center">
      Show more car
    </button>
